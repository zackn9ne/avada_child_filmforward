<?php get_header(); ?>
	...
	<div id="content" class="<?php echo $content_class; ?>" style="<?php echo $content_css; ?>">
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
			...
			<?php endif; ?>
			<div class="post-content">			<?php echo avada_render_post_metadata( 'single' ); ?>
				<?php the_content(); ?>
			...
			<div class="about-author">
				<div><h2><?php echo __('About the Author:', 'Avada'); ?> <?php the_author_posts_link(); ?></h2><div class="title-sep-container"><div class="title-sep sep-double"></div></div></div>
...
<?php 			generated_dynamic_sidebar($sidebar_1); 
